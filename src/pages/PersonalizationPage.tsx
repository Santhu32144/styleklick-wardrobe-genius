    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 py-12">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="relative bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 rounded-t-2xl p-8 text-white mb-8">
            <motion.div
          ...
          {/* Content */}
          <div className="relative bg-white/80 backdrop-blur-sm rounded-b-2xl p-8 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex gap-3 pt-4">
                <Button 
                  ...
                  className="bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 hover:from-purple-700 hover:via-pink-700 hover:to-indigo-700 text-white shadow-lg rounded-lg px-8 transition-all duration-300 flex-1"
                >
                  {isSubmitting ? (
                    <>
